	...
	public boolean ameliorer() {
		...
		if(isAmeliorationPossible()) {
			...
			if(Configuration.MODE=="debug")
				System.out.println("CASERNE DE POMPIERS : Amélioration de la caserne de pompiers à la position "+this.getPosition().toString()+"."); 

			return true;
		} else {
			if(Configuration.MODE=="debug")
				System.out.println("CASERNE DE POMPIERS : Niveau maximum déjà atteint.");
