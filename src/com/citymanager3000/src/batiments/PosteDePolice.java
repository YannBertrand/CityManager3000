	...
	public boolean ameliorer() {
		...
		if(isAmeliorationPossible()) {
			...
			if(Configuration.MODE=="debug")
				System.out.println("POSTE DE POLICE : Amélioration du Poste de Police à la position "+this.getPosition().toString()+"."); 

			return true;
		} else {
			if(Configuration.MODE=="debug")
				System.out.println("POSTE DE POLICE : Niveau maximum déjà atteint.");
