	...
	public boolean ameliorer() {
		...
		if(isAmeliorationPossible()) {
			...
			if(Configuration.MODE=="debug")
				System.out.println("CENTRALE : Amélioration de la centrale à la position "+this.getPosition().toString()+"."); 
			
			return true;
		} else {
			if(Configuration.MODE=="debug")
				System.out.println("CENTRALE : Niveau maximum déjà atteint.");
