	...
	public boolean ameliorer() {
		...
		if(isAmeliorationPossible()) {
			...
			if(Configuration.MODE=="debug")
				System.out.println("PARC EOLIEN : Amélioration du parc éolien à la position "+this.getPosition().toString()+"."); 

			return true;
		} else {
			if(Configuration.MODE=="debug")
				System.out.println("PARC EOLIEN : Niveau maximum déjà atteint.");
