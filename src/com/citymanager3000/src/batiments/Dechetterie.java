	...
	public boolean ameliorer() {
		...
		if(isAmeliorationPossible()) {
			...
			if(Configuration.MODE=="debug")
				System.out.println("DECHETTERIE : Amélioration de la déchetterie à la position "+this.getPosition().toString()+"."); 

			return true;
		} else {
			if(Configuration.MODE=="debug")
				System.out.println("DECHETTERIE : Niveau maximum déjà atteint.");
